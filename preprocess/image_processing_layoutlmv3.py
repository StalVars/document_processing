...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_file", required=False, default=None, type=str, help="Path to the output file")
    ...
    if args.output_file is not None:
     ...
     output_file = input_file +"_ocr.json"

    image = Image.open(args.input_file).convert("RGB")

    layoutlmv3proc = LayoutLMv3ImageProcessor()

    data = layoutlmv3proc.preprocess(image)
